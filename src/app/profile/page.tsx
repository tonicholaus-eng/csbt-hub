...
export const metadata: Metadata = {
  title: "My Profile",
  description: "Manage your CSBT HUB profile, inventory, wishlist, value alerts, notifications, and saved trades.",
};
      ...
      <div className="relative z-10 min-w-0 lg:pl-72">
        <div className="mx-auto w-full max-w-[1320px] px-3 pb-28 pt-6 sm:px-6 sm:pb-32 sm:pt-9 lg:px-8">
          <header className="mb-7 sm:mb-9">
            ...
            <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-950 dark:text-white sm:text-5xl">Profile & account</h1>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 dark:text-slate-400 sm:text-base">Your CSBT account for inventory, wishlist, value alerts, notifications, saved trades, community voting, and future Roblox verification.</p>
          </header>
          <ProfileDashboard />
        </div>
        <Footer />
