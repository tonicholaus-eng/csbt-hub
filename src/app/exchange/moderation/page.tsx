...
export const metadata = {
  title: "Moderation Desk — CSBT Exchange",
  description: "Staff-only CSBT Exchange safety and report moderation queue.",
};

export default function ExchangeModerationPage() {
  return (
