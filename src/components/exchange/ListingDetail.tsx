...
export default function ListingDetail({ listingId }: { listingId: string }) {
  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
      ...
      {offerOpen && user && <OfferComposer supabase={client} listing={listing} inventory={inventory} onClose={() => setOfferOpen(false)} onSent={() => { setOfferOpen(false); window.location.href = "/exchange?tab=offers"; }} />}
