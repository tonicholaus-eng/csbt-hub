...
export const navLinks = {
  ...
  exchange:{id:"exchange",label:"CSBT Exchange",href:"/exchange",description:"Find trades across CSBT games",icon:"exchange",badge:"SMART",tour:"nav-exchange",mobileLabel:"Trade"},
  ...
  opinions:{id:"opinions",label:"Trade Opinions",href:"/trade-opinions",description:"Community Win / Fair / Lose",icon:"tradefeed",tour:"nav-trade-feed"},
  history:{id:"history",label:"My Trades",href:"/trades",description:"Saved & completed trades",icon:"calculator"},
  demand:{id:"demand",label:"Demand",href:"/demand",description:"External trends & live Exchange activity",icon:"demand",badge:"LIVE"},
  wishlist:{id:"wishlist",label:"Wishlist & Alerts",href:"/wishlist",description:"Wanted items & value alerts",icon:"wishlist"},
  lounge:{id:"lounge",label:"CSBT Lounge",href:"/lounge",description:"Live multi-game trading community",icon:"community",badge:"LIVE",mobileLabel:"Community"},
  ...
  nich:{id:"nich",label:"NICH",href:"/nich",description:"CSBT trading assistant",icon:"nich",tour:"nav-nich"},
...
export const navGroups:CSBTNavGroup[]=[
  {id:"start",title:"Explore",description:"Home, values and market demand",tour:"group-start",defaultOpen:true,links:[navLinks.home,navLinks.values,navLinks.demand]},
  ...
  {id:"market",title:"Collection",description:"Inventory, wishlist and alerts",tour:"group-market",defaultOpen:true,links:[navLinks.inventory,navLinks.wishlist]},
  {id:"lounge",title:"Community",description:"Lounge and trading servers",tour:"group-lounge",defaultOpen:true,links:[navLinks.lounge,navLinks.servers]},
  {id:"help",title:"Learn & Help",description:"Learn, ask NICH and get support",tour:"group-help",defaultOpen:false,links:[navLinks.academy,navLinks.nich,navLinks.feedback,navLinks.about]},
  {id:"account",title:"Account",description:"Profile and notifications",tour:"group-account",defaultOpen:false,links:[navLinks.profile,navLinks.notifications]},
];
export const mobilePrimaryLinks:CSBTNavLink[]=[navLinks.home,navLinks.values,navLinks.exchange,navLinks.inventory,navLinks.lounge];
